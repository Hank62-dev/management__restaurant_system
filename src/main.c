...
void switch_to_back(GtkButton *button, gpointer user_data) {
    gtk_widget_set_visible(window_identification, TRUE);
    gtk_widget_set_visible(Login_Register_window, FALSE);    
}
